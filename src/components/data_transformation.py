...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        try:
            ...
            logging.info("Data transformation pipelines successfully created.")
            return preprocessor
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            input_feature_test_arr = preprocessing_obj.transform(input_feature_test_df)  # Fixed test transformation
